...
const emit = defineEmits(["close", "reject", "print", "pay"]);
      ...
      >
        ...
        >
          <button
            ...
            class="flex-1 px-3 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-500 border border-red-500/20 focus:ring-2 focus:ring-red-500/50 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2"
          >
            <svg
              class="w-4 h-4"
              fill="none"
          ...
          <button
            ...
            class="flex-1 px-3 py-2 bg-green-500/10 hover:bg-green-500/20 text-green-500 border border-green-500/20 focus:ring-2 focus:ring-green-500/50 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2"
          >
            <svg
              class="w-4 h-4"
              fill="none"
          ...
          <button
            ...
            class="flex-1 px-3 py-2 bg-app-text text-app-bg hover:opacity-90 rounded-xl font-bold text-sm transition-colors flex items-center justify-center gap-2 shadow-lg"
          >
            <svg
              class="w-4 h-4"
              fill="none"
