  ...
  <div class="p-8">
    <div class="mb-8 flex justify-between items-end">
      ...
      <div class="flex gap-3">
        ...
        <button
          class="px-4 py-2 bg-orange-600 rounded-xl text-sm font-bold text-white shadow-lg shadow-orange-200 hover:bg-orange-500">
          Download Repo
        </button>
      </div>
    </div>
      ...
      <template v-else-if="stats">
        <div
          ...
          <div class="flex items-center gap-4 mb-4">
            <div class="w-12 h-12 bg-green-500/10 text-green-600 rounded-2xl flex items-center justify-center">
          ...
          <div class="text-xs text-green-600 font-bold bg-green-500/10 px-2 py-1 rounded-lg inline-block">
            +12% from last week
          </div>
        </div>

        <div class="bg-app-surface p-6 rounded-3xl border border-app-border shadow-sm">
          <div class="flex items-center gap-4 mb-4">
          ...
          <div class="text-xs text-blue-600 font-bold bg-blue-500/10 px-2 py-1 rounded-lg inline-block">
            +5 new today
          </div>
        </div>
        ...
        <div class="bg-app-surface p-6 rounded-3xl border border-app-border shadow-sm">
          <div class="flex items-center gap-4 mb-4">
            <div class="w-12 h-12 bg-orange-500/10 text-orange-600 rounded-2xl flex items-center justify-center">
              <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <div class="text-xs text-orange-600 font-bold bg-orange-500/10 px-2 py-1 rounded-lg inline-block">
            Steady growth
          </div>
        </div>
      </template>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      <!-- Revenue Chart -->
      <div class="lg:col-span-2 bg-app-surface p-8 rounded-[32px] border border-app-border shadow-sm h-96">
        <h3 class="font-bold text-app-text mb-6 flex items-center gap-2">
          Revenue Trend
          <span class="text-xs font-normal text-app-muted font-mono">(Last 7 Days)</span>
        </h3>
        <div class="h-64">
      ...
      <!-- Top Products -->
      <div class="bg-app-surface p-8 rounded-[32px] border border-app-border shadow-sm flex flex-col h-96">
        <h3 class="font-bold text-app-text mb-6">Top Selling Items</h3>
        <div v-if="stats" v-auto-animate class="flex-1 space-y-6 overflow-y-auto pr-2">
          <div v-for="product in stats.top_products" :key="product.name"
            ...
            <div class="flex-1">
              <p class="text-sm font-bold text-app-text group-hover:text-orange-600 transition-colors">
                {{ product.name }}
              </p>
